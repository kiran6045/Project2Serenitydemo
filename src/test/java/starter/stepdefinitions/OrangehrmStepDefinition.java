...
public class OrangehrmStepDefinition {
    ...
    public void enter_in_required_fields_and_search() {
        String value =directoryPage.enterEmployeeName();
        Assert.assertEquals("Odis Adalwin",value);
    ...
    public void validate_user_is_able_to_view_the_fetched_employee() {
        String value=directoryPage.getrecordsfetched();
        System.out.println(value);
        Assert.assertEquals(value,"Chief Technical Officer");
